...
#import "CWCommonTools+UI.h"

@implementation CWCommonTools (UI)
...
- (UIImage *)getLinearGradientImage:(NSArray <UIColor *> * )colors directionType:(CWGradientDirection)directionType size:(CGSize)size {
    ...
    if (directionType == kCWLinearGradientDirectionLeftToRight) {
        gradientLayer.startPoint = CGPointMake(0, 0);
        gradientLayer.endPoint = CGPointMake(1, 0);
    }else if (directionType == kCWLinearGradientDirectionTopToBottom){
        gradientLayer.startPoint = CGPointMake(0, 0);
        gradientLayer.endPoint = CGPointMake(0, 1);
    }else if (directionType == kCWLinearGradientDirectionLeftTopToRightBottom){
        gradientLayer.startPoint = CGPointMake(0, 0);
        gradientLayer.endPoint = CGPointMake(1, 1);
    }else if (directionType == kCWLinearGradientDirectionLeftBottomToRightTop){
