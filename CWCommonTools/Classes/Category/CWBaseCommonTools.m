...
@implementation CWCommonTools

///工具的单例 singleton
+ (CWCommonTools *)sharedCWCommonTools {
    static CWCommonTools *aCommonTools;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        aCommonTools = [[CWCommonTools alloc] init];
    });
    return aCommonTools;
}
...
- (NSString *)setCWDebugLogToFile {
    ...
    NSString *fileName = [NSString stringWithFormat:@"CWNSLog.txt"];// 注意不是NSData!
